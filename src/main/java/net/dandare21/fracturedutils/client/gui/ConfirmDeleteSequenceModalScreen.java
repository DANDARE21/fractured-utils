...
public class ConfirmDeleteSequenceModalScreen extends Screen {
    ...
    public ConfirmDeleteSequenceModalScreen(Screen parentScreen, String fileName, Runnable onDeleteConfirmed) {
        super(Component.literal("Confirm Delete Sequence"));
        this.parentScreen = parentScreen;
        this.fileName = fileName != null ? fileName : "sequence.json";
    ...
    protected void init() {
        ...
        // [DELETE] (Red) & [CANCEL] (Cyan) Buttons
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTick) {
        ...
        // Header Title Bar (Red Accent)
        graphics.fill(left, top, left + panelWidth, top + 26, 0xEE200810);
        graphics.fill(left, top + 25, left + panelWidth, top + 26, RED_DELETE);
        graphics.drawString(this.font, "DELETE SEQUENCE FILE", left + 12, top + 8, RED_DELETE, false);

        // Warning Text
        graphics.drawString(this.font, "Are you sure you want to delete sequence:", left + 20, top + 42, 0xFFAABBCC, false);
